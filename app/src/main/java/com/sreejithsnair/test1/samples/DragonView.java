package com.sreejithsnair.test1.samples;
...
import com.sreejithsnair.test1.R;

import java.util.concurrent.CompletableFuture;
import java.util.concurrent.ExecutionException;

public class DragonView extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_dragon_view);
        ...
        CompletableFuture.allOf(dragon, backdrop)
                .handle((ok, ex) -> {
                    try {
                        ...
                        modelNode1.setLocalScale(new Vector3(0.5f, 0.3f, 0.5f));
                        modelNode1.setLocalRotation(Quaternion.multiply(
                                Quaternion.axisAngle(new Vector3(1f, 0f, 0f), 30),
                        ...
                        modelNode3.setLocalRotation(Quaternion.axisAngle(new Vector3(0f, 1f, 0f), 60));
